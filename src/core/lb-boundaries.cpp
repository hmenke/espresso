...
void lb_init_boundaries() {
  ...
  if (lattice_switch & LATTICE_LB_GPU) {
    ...
    if (n_lb_boundaries || pdb_boundary_lattice)
      lb_init_boundaries_GPU(n_lb_boundaries, n_lb_moving_boundaries, number_of_boundnodes, host_boundary_node_list, host_boundary_index_list, boundary_velocity, host_moving_boundary);
