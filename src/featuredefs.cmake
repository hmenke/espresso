...
# Define features
macro(FEATURE)
  list(APPEND FEATURE_FLAGS "${ARGN}")
endmacro()
  ...
  foreach(F_NAME ${ARGN})
    ...
    foreach(F_EXT ${FEATURES_EXTERNAL_KNOWN})
      ...
      if(NOT FEATURE_FOUND EQUAL -1)
        ...
        if(FEATURE_FOUND EQUAL -1)
          message(FATAL_ERROR "${F_NAME} required external feature ${F_EXT} but it is not available.")
        endif()
      endif()
    endforeach()
...
DEFINE_FEATURE(NAME SCAFACOS_DIPOLES                REQUIRES SCAFACOS IMPLIES DIPOLES)
...
if(EXISTS "${MYCONFIG_FILE}")
  include(${MYCONFIG_FILE})
else()
  message(STATUS "No myconfig.cmake found.  Using myconfig_default.cmake instead.")
  include(${CMAKE_CURRENT_SOURCE_DIR}/myconfig_default.cmake)
endif()
